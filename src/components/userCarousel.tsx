...
const users = [
    ...
    {id: 8, pic: '/images/8.jpg', from: 'января 2019', name: 'Зеленина Наталья Валерьевна', status: 'Волонтёр. Запись на операцию по контролю численности'},
    {id: 9, pic: '/images/9.jpg', from: 'января 2019', name: 'Джавадова Азиза Аятдиновна', status: 'Волонтёр'},
    {id: 10, pic: '/images/10.jpg', from: 'января 2019', name: 'Вырва Кристина Алексеевна', status: 'Дежурная'},
