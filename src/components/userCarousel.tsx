...
const users = [
    ...
    {id: 7, pic: '/images/8.jpg', from: 'января 2019', name: 'Зеленина Наталья Валерьевна', status: 'Волонтёр. Запись на операцию по контролю численности'},
    {id: 8, pic: '/images/9.jpg', from: 'января 2019', name: 'Джавадова Азиза Аятдиновна', status: 'Волонтёр'},
    {id: 9, pic: '/images/10.jpg', from: 'января 2019', name: 'Вырва Кристина Алексеевна', status: 'Дежурная'},
    {id: 10, pic: '/images/11.jpg', from: 'марта 2019', name: 'Скрипилина Ксения Сергеевна', status: 'Волонтёр. Запись на операцию по контролю численности'}
]
